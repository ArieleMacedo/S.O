...
export class Tarefa {
  ...
  constructor(ingresso: number, duracao: number, prioridade: number ) {
...
let esc: Escalonador = new Escalonador(2, 0);

let t1: Tarefa = new Tarefa(0, 5, 2);
let t2: Tarefa = new Tarefa(0, 2, 3);
let t3: Tarefa = new Tarefa(1, 4, 1);
let t4: Tarefa = new Tarefa(3, 1, 4);
let t5: Tarefa = new Tarefa(5, 2, 5);
