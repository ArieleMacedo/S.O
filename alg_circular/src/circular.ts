...
export class Escalonador {
  ...
  adicionarTarefa(tarefas: Tarefa[]): void{
...
let esc: Escalonador = new Escalonador(15,4);

let t1: Tarefa = new Tarefa(5,10);
let t2: Tarefa = new Tarefa(15,30);
let t3: Tarefa = new Tarefa(10,20);
let t4: Tarefa = new Tarefa(0,40);


esc.adicionarTarefa([t1,t2,t3,t4]);
