...
const circular_prioridade_1 = require("./circular_prioridade"); // ajuste o caminho conforme seu projeto
...
class App {
    ...
    configurarEscalonador() {
        ...
        this.esc = new circular_prioridade_1.Escalonador(quantum, tc);
        this.tarefas = [];
    ...
    adicionarTarefa() {
        ...
        for (let i = 0; i < qtd; i++) {
            ...
            const tarefa = new circular_prioridade_1.Tarefa(ingresso, duracao, prioridade);
