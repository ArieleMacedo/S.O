...
class Escalonador {
    ...
    gerarResumo(tarefas) {
        ...
        for (const t of tarefas) {
            ...
            somaVida += vida;
            somaEspera += espera;
            console.log(`${String(t.id).padEnd(3)}| ` +
...
let esc = new Escalonador(5, 0);
let t1 = new Tarefa(0, 5);
let t2 = new Tarefa(0, 2);
let t3 = new Tarefa(1, 4);
let t4 = new Tarefa(3, 1);
let t5 = new Tarefa(5, 2);
